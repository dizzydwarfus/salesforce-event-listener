...
ReplayParameter = Union[
    ReplayOption, ReplayMarkerStorage, MutableMapping[str, ReplayMarker]
]
...
class Client(CometdClient):
    ...
    def __init__(
        ...
        *,
        ...
        replay_storage_policy: ReplayMarkerStoragePolicy = ReplayMarkerStoragePolicy.AUTOMATIC,
        ...
        if not isinstance(replay_storage, ReplayMarkerStorage):
            raise TypeError(
                "{!r} is not a valid type for the replay " "parameter.".format(
...
class SalesforceStreamingClient(Client):
    ...
    def __init__(
        ...
        *,  # pylint: disable=too-many-locals
        ...
        """
        :param domain: Salesforce domain
